...
with dag:
    ...
    # downloads_path_dir is /usr/local/airflow/project/downloads
    downloads_path_dir = var_path_dir["downloads_path_dir"]

    # archive_path_dir /usr/local/airflow/project/archive
    archive_path_dir = var_path_dir["archive_path_dir"]
    ...
    move_file_cmd = 'mv {}{}{{{{ ti.xcom_pull(task_ids="ETL_data") }}}} {}/.'\
                    .format(downloads_path_dir, '/', archive_path_dir)
